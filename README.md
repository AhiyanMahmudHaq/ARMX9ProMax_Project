...
The typical device specifications for the "TX9PROMAX" TV box are given below:

Important links to documentation of components found on the motherboard/mainboard:
